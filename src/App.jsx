...
const App = () => {
  ...
  const token = useToken("0x15990D76bb88b080b44A338cDf05aD3e8B1F6e3D");

  const vote = useVote("0x15aA5de62CBE0dB9c78BB2e29509A02B19c43eCc");
  ...
  if (address && network?.[0].data.chain.id !== ChainId.Mumbai) {
    return (
      <div className="unsupported-network">
        <h2>Por avor conecta na Mumbai aí</h2>
        <p>
          Esse dapp só funciona na rede da Mumbai, por favor mude as redes na
  ...
  if (hasClaimedNFT) {
    return (
      <div className="member-page">
        ...
        <p>Parabéns por ser um membro</p>
        <div>
          <div>
          ...
          <div>
                ...
                try {
                  ...
                  try {
                    ...
                    try {
                      ...
                      console.error("falha na execução dos votos", err);
                    }
                  } catch (err) {
                    console.error("falha em votar", err);
                  }
                } catch (err) {
            ...
            >
              ...
              {!hasVoted && (
                <small>
                  Isso vai engatilhar multiplas transações que você necessita
                  assinar.
                </small>
              )}
            </form>
